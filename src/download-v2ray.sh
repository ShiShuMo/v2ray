_get_latest_version() {
	v2ray_repos_url="https://api.github.com/repos/ShiShuMo/v2ray-core/releases/latest?v=$RANDOM"
...
_download_v2ray_file() {
	...
	v2ray_download_link="https://github.com/ShiShuMo/v2ray-core/releases/download/$v2ray_latest_ver/v2ray-linux-${v2ray_bit}.zip"
